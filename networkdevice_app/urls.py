...
urlpatterns = [
    ...
    path('deviceport/', DevicePortListCreateAPIView.as_view(), name='deviceport-list-create'),
    path('deviceport/<int:pk>/', DevicePortRetrieveUpdateDestroyAPIView.as_view(), name='deviceport-detail'),
